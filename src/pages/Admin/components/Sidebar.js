...
export const Sidebar = () => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const toggle_theme_btn = document.getElementById("admin_toggle_theme_btn");
    const exit_btn = document.getElementById("admin_exit_btn");
    ...
    <div class="h-screen w-75 bg-sg-white shadow-[0_10px_50px_5px_theme(colors.sg.gray)] p-8 transition-all dark:bg-sg-black dark:shadow-[0_10px_50px_5px_black] w-22!">
        ...
        <div class="hidden flex items-center flex-col gap-2">
          <div class="flex flex-col items-center">
              ...
              <h1 class="mt-4 font-semibold text-3xl dark:text-sg-white">Admin</h1>
          </div>
          <button type="button" class="bg-sg-gray w-35 h-10 text-white font-bold rounded-lg" id="admin_toggle_theme_btn">Toggle Theme</button>
          <button type="button" class="bg-sg-gray w-35 h-10 text-white font-bold rounded-lg" id="admin_exit_btn">Exit</button>
        </div>
    </div>
    `;
};
